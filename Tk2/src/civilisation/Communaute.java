...
/** 
 * Une communauté, point de rassemblement d'un peuple
 * @author DTEAM
 * @version 1.0 - 2/2013
*/
...
public class Communaute extends Turtle 
{
	...
	/**
	 * Action unique appellée seulement use seule fois pour initialiser certaines informations
	...
	/**
	 * Action unique appellée seulement use seule fois pour initialiser certaines informations.
	 * Permet de creer les agents liés à cette communauté
	 * @return Action suivante de la communaute
	 */
