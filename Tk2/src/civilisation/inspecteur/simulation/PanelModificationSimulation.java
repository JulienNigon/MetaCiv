...
public class PanelModificationSimulation extends JPanel{
	...
	public PanelModificationSimulation()
	{
		...
		limitesEnvironnement.setToolTipText("DŽfinir les limites de l'environnement");
		...
		genererEnvironnement.setToolTipText("Generer un environnement ˆ partir d'une image existante");
